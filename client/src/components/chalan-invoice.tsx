          ...
          <div className="border border-foreground/20 p-4 print:border-black">
            ...
            {chalan.termsAndConditions && (
              <div className="mt-4 pt-3 border-t border-foreground/20">
                <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide mb-2">Terms & Conditions</p>
                <p className="text-xs whitespace-pre-wrap text-foreground">{chalan.termsAndConditions}</p>
              </div>
            )}
          </div>
        </div>
